...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = IR_8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(IR_8_GPIO_Port, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Pin = IR_6_Pin|IR_7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(IR_8_GPIO_Port, IR_8_Pin);

    HAL_GPIO_DeInit(GPIOA, IR_1_Pin|IR_2_Pin|IR_3_Pin|IR_4_Pin
                          |IR_5_Pin);

    HAL_GPIO_DeInit(GPIOB, IR_6_Pin|IR_7_Pin);
